 ...
 *   Production: npx tsx scripts/check-console-errors.ts https://ananyarangaraju.com
 *
...
function getUrls(): string[] {
  ...
  urls.push('https://ananyarangaraju.com/privacy')

  // Convert to use the base URL
  return urls.map(url => url.replace('https://ananyarangaraju.com', baseUrl))
}
