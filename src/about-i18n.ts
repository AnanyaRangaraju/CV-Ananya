...
export const aboutContent = {
  ...
  en: {
    ...
    bio: [
      ...
      "I'm currently pursuing a Master of Engineering Management at Dartmouth College (2024-2026), and I hold a B.Tech in Computer Science & Engineering from Manipal University Jaipur (CGPA 3.9/4.0).",
      'What motivates me is building things that scale globally and solve real problems for the people using them.',
      "I'm also someone who genuinely listens. If you need someone to sit with a hard problem, ask the right questions, and actually care about getting it right, that's me.",
    ],
