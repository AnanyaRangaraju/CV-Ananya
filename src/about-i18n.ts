...
export const aboutContent = {
  ...
  en: {
    ...
    manifesto: "AI systems don't fail at the model. They fail at the edges no one instrumented.",
    subtitle: 'AI Systems & Product Engineer · Ex-Oracle Health · Dartmouth MEM',
    location: 'Hanover, NH · Open to relocate',
    lastUpdated: 'July 2026',
    bio: [
      'Software developer with two years shipping production AI at Oracle Health (formerly Cerner), where she owned observability for clinical AI agents deployed across 100+ client sites and 1M+ monthly interactions, and built validation frameworks that cut downstream prediction inconsistencies by 25%.',
      'Builder of Clearance, an AI agent evaluation platform that benchmarks LLMs including GPT-4o, GPT-4o mini, Claude Sonnet 4.5, and Gemini 2.5 Flash on real-world reliability rather than benchmark accuracy alone, surfacing gaps as large as 61 points between the two.',
      'Currently pursuing a Master of Engineering Management at Dartmouth College (2024-2026), sharpening the product and strategy side of applied AI. B.Tech in Computer Science & Engineering from Manipal University Jaipur (CGPA 3.9/4.0).',
    ],
