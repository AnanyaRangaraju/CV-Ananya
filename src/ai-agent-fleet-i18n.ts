...
export const aiAgentFleetContent = {
  es: {
    ...
    tldr: 'career-ops es mi sistema open source de búsqueda de empleo: 59.789 estrellas en GitHub, 171 contribuidores y 552 PRs fusionadas a fecha de hoy. Lo mantengo en unas 4 horas a la semana. Una flota de agentes Claude Code hace el trabajo mecánico — triage, testing, review briefs, mecánica de releases, métricas de comunidad. Gates duros los mantienen honestos, y cada fallo real se destila en una regla que cargan al arrancar.',
    tldrCoin: {
      pre: ' ',
    ...
    sections: {
      ...
      numbers: {
        ...
        asOf: 'A 13 de julio de 2026:',
        table: {
          headers: ['Métrica', 'Valor'],
          rows: [
            ['Estrellas en GitHub', '59.789'],
            ['Forks', '11.878'],
            ['Contribuidores', '171'],
            ['PRs fusionadas', '552'],
        ...
        dora: {
          ...
          post: ' midió lo que la mayoría de los equipos de ingeniería ya siente: la IA dispara el output individual (un 98% más de PRs fusionadas) mientras las métricas de delivery organizacional se quedan planas. Su hallazgo principal es que la IA amplifica el sistema en el que aterriza. El hueco entre esos dos números vive en todo lo que describe este artículo: review, confianza, memoria, gates. Este repo es ese hueco cerrado en público, a escala de 59.000 estrellas, con 4 horas a la semana.',
        },
      },
      community: {
      ...
      cta: {
        ...
        ctaLabel: 'Escríbeme',
        ctaHref: 'mailto:hola@santifer.io',
  ...
  en: {
    ...
    tldr: 'career-ops is my open source job-search system: 59,789 GitHub stars, 171 contributors and 552 merged PRs as of today. I maintain it in about 4 hours a week. A fleet of Claude Code agents does the mechanical work — triage, testing, review briefs, release mechanics, community metrics. Hard gates keep them honest, and every real failure gets distilled into a rule they load on boot.',
    tldrCoin: {
      pre: ' ',
      term: 'Agentic maintenance',
