...
// Console easter egg
console.log('%c Ananya Rangaraju ', 'background: #f97316; color: #1a1a1a; font-size: 16px; font-weight: bold; padding: 6px 12px; border-radius: 3px;')
...
console.log('%c Let\'s solve something hard, ananya.rangaraju@gmail.com ', 'background: #f97316; color: #1a1a1a; font-size: 13px; font-weight: bold; padding: 4px 8px; border-radius: 3px;')

// Debug API for technical recruiters — type window.__ananya in console
Object.defineProperty(window, '__ananya', {
  value: Object.freeze({
...
function NotFound() {
  useEffect(() => {
    ...
    document.title = '404, page not found | Ananya Rangaraju'
